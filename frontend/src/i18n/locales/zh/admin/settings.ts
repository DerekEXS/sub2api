export default {
    settings: {
      ...
      registrationAudit: {
        ...
        configUaCheck: 'UA 检查',
        configUaCheckHint: '对携带可疑/自动化 UA 字符串的注册请求进行打标。',
        configCgnatExempt: 'CGNAT 豁免',
        configCgnatExemptHint: '豁免共享 CGNAT 出口 IP 的注册，避免同 IP 频率信号误伤。',
        configFlagThreshold: '打标阈值',
        configStrongThreshold: '强标阈值',
        configEmailLongLocal: '长本地最小长度',
        configEmailVowelRatio: '元音最大比例（0-1）',
        configScoreEmailRandom: '随机邮箱分值',
        configScoreEmailAlias: '别名邮箱分值',
        configScoreEmailWhitelist: '白名单邮箱分值',
        configScoreRhythm: '注册节奏分值',
        configScore24h45: '24h 4-5 次注册分值',
        configScore24h6plus: '24h 6 次以上注册分值',
        configScoresHint: '分值允许为负数（如白名单奖励分）；总分越高风险越高。',
