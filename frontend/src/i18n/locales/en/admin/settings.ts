export default {
    settings: {
      ...
      registrationAudit: {
        ...
        configUaCheckHint: 'Flag registrations arriving with suspicious or automated User-Agent strings.',
        configCgnatExempt: 'CGNAT Exemption',
        configCgnatExemptHint: 'Exempt registrations behind shared CGNAT egress IPs from IP-frequency signals.',
        configFlagThreshold: 'Flag Threshold',
        configStrongThreshold: 'Strong Threshold',
        configEmailLongLocal: 'Long Local-part Min Length',
        configEmailVowelRatio: 'Vowel Ratio Max (0-1)',
        configScoreEmailRandom: 'Random Email Score',
        configScoreEmailAlias: 'Alias Email Score',
        configScoreEmailWhitelist: 'Whitelist Email Score',
        configScoreRhythm: 'Registration Rhythm Score',
        configScore24h45: '24h 4-5 Sign-ups Score',
        configScore24h6plus: '24h 6+ Sign-ups Score',
        configScoresHint: 'Scores may be negative (e.g. whitelist bonus). Higher total score means higher risk.',
