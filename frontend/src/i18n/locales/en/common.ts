export default {
  ...
  agentService: {
    ...
    restartButton: 'Restart Agent',
    downloadButton: 'Download Archive',
    retainedTitle: 'Agent stopped, data retained',
