export default {
  ...
  nav: {
    ...
    agentService: 'Cloud Agent',
    agentAdmin: 'Cloud Agent Management',
  },

  // Cloud Agent (one-click cloud PicoClaw Agent)
  agentService: {
    title: 'Cloud Agent',
    description:
      'Deploy your dedicated Cloud Agent in one click. A dedicated Cloud Agent API key is automatically generated (best-rate group, automatically deleted when stopped); instance data is fully isolated; idle instances are automatically destroyed — download your archive before destruction, data is not recoverable afterwards.',
    ...
    statusRetained: 'Stopped · Data retained',
    statusError: 'Error',
    statusUnknown: 'Unknown',
    startButton: 'Start Cloud Agent',
    stopButton: 'Stop Cloud Agent',
    restartButton: 'Restart Cloud Agent',
    downloadButton: 'Download Archive',
    retainedTitle: 'Cloud Agent stopped, data retained',
    retainedHint: 'The instance is stopped. Workspace data can still be recovered within the retention period. Once the retention period or hard cap expires, data will be cleaned up — please download your archive in time.',
    idleLabel: 'Idle Timeout',
    retainLabel: 'Retention',
    hardcapLabel: 'Hard Cap',
    queuedHint: 'Waiting for capacity, position',
    queuedProvisioning: 'Provisioning...',
    agentUiTitle: 'PicoClaw Web UI',
    launchNote: 'Clicking start automatically generates a new Cloud Agent key and injects it into the instance',
    passwordLabel: 'Access Password',
    copyButton: 'Copy',
    copied: 'Copied',
    emptyTitle: 'Cloud Agent not started',
    emptyHint:
      'Click "Start Cloud Agent" to create and run your dedicated PicoClaw container. A dedicated "Cloud Agent" API key is generated automatically (bound to the current best-rate group, auto-deleted when stopped); instance data is fully isolated.',
    emptyNote:
      'After a period of idle time the instance is automatically destroyed and enters a retention period during which restarting recovers your data. When either the retention period or the hard cap (counted from first start) expires, all data is cleared. Data is not stored permanently — it is cleaned up after a certain time; refer to the Cloud Agent page for exact durations. Please download your data in time.',
