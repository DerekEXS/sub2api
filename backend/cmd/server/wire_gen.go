...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	agentManagerClient := service.ProvideAgentManagerClient(configConfig)
	agentKeyProvisioner := service.NewAPIKeyAgentProvisioner(apiKeyService)
	agentService := service.NewAgentService(agentStore, agentManagerClient, agentKeyProvisioner, configConfig)
