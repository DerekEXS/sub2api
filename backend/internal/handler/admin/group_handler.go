...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	if err := service.ValidatePeakRateConfig(req.PeakRateEnabled, req.PeakStart, req.PeakEnd, float64ValueOrDefault(req.PeakRateMultiplier, 1.0), req.PeakWindows); err != nil {
