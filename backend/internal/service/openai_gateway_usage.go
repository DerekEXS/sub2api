...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	// pricingAt 在此声明：后续 calculateOpenAIRecordUsageCost 与 response-model 重算均依赖。
	...
	multiplier, imageMultiplier := computePeakAwareMultipliers(apiKey, baseMultiplier, pricingAt, billingModel)
